...
public class ReconRowMapper implements RowMapper<Recon>{

	@Override
	public Recon mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		recon.setRequestJson(rs.getBytes("REQUEST_JSON"));
		recon.setResponseJson(rs.getBytes("RESPONSE_JSON"));
		recon.setCurrentStatus(rs.getString("CURRENT_STATUS"));
