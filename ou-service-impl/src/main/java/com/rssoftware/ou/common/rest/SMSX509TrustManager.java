...
public class SMSX509TrustManager implements X509TrustManager {

	private static final Logger log = LoggerFactory.getLogger(SMSX509TrustManager.class);
	...
	static {
		try {
			...
			InputStream is = new FileInputStream(new File(System.getProperty("sms.cert", "/u01/bbpou/certificate/ssl/haproxy.crt")));
