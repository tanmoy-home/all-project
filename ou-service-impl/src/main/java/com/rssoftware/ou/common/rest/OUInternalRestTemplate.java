...
public class OUInternalRestTemplate {
	...
	private final static Logger log = LoggerFactory.getLogger(OUInternalRestTemplate.class);
...
//		}
	...
	@SuppressWarnings("unchecked")
	public <T> ResponseEntity<T> exchange(String url, HttpMethod method,HttpEntity<T> httpEntity, Class responseType, Object ...urlVariables) {
//		int i = 0;
//		while (true) {
//			try {
				return restTemplate.exchange(url, method, httpEntity, responseType, urlVariables);
//			} catch (ResourceAccessException e) {
//				if (i <= MAX_RETRY_COUNT) {
//					throw e;
//				}
