...
public class ProxyDataSource implements javax.sql.DataSource {

	String tenantId = TransactionContext.getTenantId();
	String qualifier = TransactionContext.BEAN_DATA_SOURCE_PREFIX+tenantId;
	BBPSDataSource dataSource = BeanLocator.getBean(qualifier, BBPSDataSource.class);
