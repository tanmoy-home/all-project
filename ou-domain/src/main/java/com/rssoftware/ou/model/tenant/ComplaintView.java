...
public class ComplaintView {
	...
	List<ComplaintStatusView> statChgHistoryList;
	...
	private String txnDateIntFlg;

	private String txnInterval;
	...
	public List<ComplaintStatusView> getStatChgHistoryList() {
		return statChgHistoryList;
	}

	public void setStatChgHistoryList(
			List<ComplaintStatusView> statChgHistoryList) {
	...
	public String getTxnDateIntFlg() {
		return txnDateIntFlg;
	}

	public void setTxnDateIntFlg(String txnDateIntFlg) {
		this.txnDateIntFlg = txnDateIntFlg;
	}

	public String getTxnInterval() {
		return txnInterval;
	}

	public void setTxnInterval(String txnInterval) {
		this.txnInterval = txnInterval;
	}
