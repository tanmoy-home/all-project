...
public class UPIByteArrayLengthHeaderSerializer extends ByteArrayLengthHeaderSerializer{
...
/*		byte[] responseHeaderFromIMPS = new byte[2];
		...
		System.out.println("responseHeaderFromIMPSHex"+responseHeaderFromIMPSHex);
		int lengthOfHalfDataBlock = hex2decimal(responseHeaderFromIMPSHex);
		System.out.println("lengthOfHalfDataBlock_first 2 bytes"+lengthOfHalfDataBlock);*/
		
		int lengthOfHalfDataBlock = readHeader(inputStrm);
...
/*		String finalizedRespose = bytesToHex(responseHeaderFromIMPS)
	   ...
	   @Override
	protected int readHeader(InputStream arg0) throws IOException {
		   
		   DataInputStream in = new DataInputStream(arg0);
			byte[] responseHeaderFromIMPS = new byte[2];

			in.read(responseHeaderFromIMPS);
			/*for(byte b : responseHeaderFromIMPS ){
				System.out.println("BYTE MSG:"+b);
			}*/
			//System.out.println("read header complete inside readHeader");
			String responseHeaderFromIMPSHex = bytesToHex(responseHeaderFromIMPS);
			//System.out.println("responseHeaderFromIMPSHex"+responseHeaderFromIMPSHex);
			int lengthOfHalfDataBlock = hex2decimal(responseHeaderFromIMPSHex);
			//System.out.println("lengthOfHalfDataBlock_first 2 bytes"+lengthOfHalfDataBlock);
			
			return lengthOfHalfDataBlock;
/*		// TODO Auto-generated method stub
		return super.readHeader(arg0);*/
	}
}
